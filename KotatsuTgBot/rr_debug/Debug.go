...
//
// ------------------------------------
// Базовый движок Crypto

//
// ----------------------------------------------------------------------------------
//
// 				Debug (Модуль функций для отладки, главный файл)
//
// ----------------------------------------------------------------------------------
//
...
func SaveFileObject(object interface{}) error {
	// Конвертируем объект update в JSON формат. update - замените на ваш файл JSON для отладки
